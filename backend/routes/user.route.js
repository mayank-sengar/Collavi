...
import { getRecommendedUsers, getMyFriends,sendFriendRequest,acceptFriendRequest,
    getFriendRequests,getOutgoingFriendRequests,rejectFriendRequest,editProfile } from '../controllers/user.controller.js';
...
router.route('/edit-profile').put(editProfile);
